...
while nCirquitos != -1: #isdigit() == true if all the characters are digits
    #print('No es un integer.')
    nCirquitos = int(input('Introduzca el cuantos cirquitos tienes(numero positivo).Si quieres salir escribe "-1".:'))
    ...
    if nCirquitos > 0:
        ...
        print('Haz introducido u 0.')
    else:
        print('No haz introducido un numero.')
